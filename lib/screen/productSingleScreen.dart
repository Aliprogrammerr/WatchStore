    ...
    return SafeArea(
      ...
      appBar: CustomAppbar(
        ...
        children: [
          ...
          IconButton(
              onPressed: () {}, icon: SvgPicture.asset("assets/svg/close.svg"))
        ],
      )),
      body: Stack(
        children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "this is the discription that i was talking abou tbro ",
                        style: LightAppTextStyle.caption,
                      ),
                      Dimens.medium.height,
                      const ProductTapView()
                    ],
                  ),
                )
              ],
  ...
  Widget build(BuildContext context) {
    return Positioned(
        ...
        child: Container(
          ...
          width: double.infinity,
          height: 60,
          decoration: const BoxDecoration(color: LightAppColors.appbar),
          child: Row(
                          ...
                          child: Positioned(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                "$discount%",
                                style: LightAppTextStyle.selectedTabView
                                    .copyWith(
                                        fontSize: 12,
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) => GestureDetector(
                    ...
                    child: Text(tabList[index],
                        style: index == selectextIndex
                            ? LightAppTextStyle.selectedTabView
                            : LightAppTextStyle.unSelectedTabView),
                  )),
        ),
        SizedBox(
          width: double.infinity,
          ...
          child: IndexedStack(
            ...
            children: const [First(), Second(), Thirsd()],
          ),
        )
      ],
    );
